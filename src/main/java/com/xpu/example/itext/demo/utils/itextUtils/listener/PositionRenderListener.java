...
package com.xpu.example.itext.demo.utils.itextUtils.listener;

import com.itextpdf.awt.geom.Rectangle2D.Float;
import com.itextpdf.text.pdf.parser.ImageRenderInfo;
import com.itextpdf.text.pdf.parser.RenderListener;
import com.itextpdf.text.pdf.parser.TextRenderInfo;
import com.xpu.example.itext.demo.utils.itextUtils.ReplaceRegion ;
...
public class PositionRenderListener implements RenderListener {
    ...
    private float fixHeight;    //可能出现无法完全覆盖的情况，提供修正的参数，默认为3
